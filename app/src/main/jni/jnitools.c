...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved){
    ...
    const JNINativeMethod method[]={
            {"addNumber","(II)I",(void*)addNumber},
            {"subNumber","(II)I",(void*)subNumber},
            {"mulNumber","(II)I",(void*)mulNumber},
            {"divNumber","(II)I",(void*)divNumber}
    };

    //找到对应的JNITools类
    jclass jClassName=(*env)->FindClass(env,"com/test/demos/demos/jni/JniTools");
